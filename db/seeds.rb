...
", location: "Barcelona", category: categories.sample, start_time: "12/12/2020 11:00am", end_time: "12/12/2020 4:00pm", user: user1, organization: organization1)
...
", location: "Barcelona", category: categories.sample, start_time: "12/12/2020 11:00am", end_time: "12/12/2020 4:00pm", user: user2, organization: organization2)
# event_photo1 = URI.open("https://cleanbeachinitiative.org/wp-content/uploads/2020/04/EU-Plastic-Ban.jpg")
# event1.photo.attach(io: event_photo1, filename: "event_photo1.png", content_type: "image/png")
event2.save
